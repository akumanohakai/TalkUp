...
<body>
    <div class="container" style="margin-top: 100px; margin-bottom: 0px;">
        ...
        <div class="row" id="divCartas" style="background-color: transparent; border: 0px;">
            <div class="row" id="fila" style="display: none; background-color: transparent"></div>
        </div>
    </div>
    <div class="bottom-bar" style="display: none;">
        <strong id="info">Información de la partida</strong>
        <span style="margin-left: 10px">Número de intentos: <span id="intentos" style="margin-left: 0">0</span></span>
        ...
        <button class="btn btn-block btn-danger" data-target="#modalReiniciar" data-toggle="modal" id="btnReiniciar" style="margin:10px">Iniciar nueva partida</button>
    </div>
